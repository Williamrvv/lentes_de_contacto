...
//echo "$correo";
     ...
     // primero hay que incluir la clase phpmailer para poder instanciar 
      ...
      $mail->Subject = "Pedido orden #($tim) Lentes Europa Scleral";
            ...
            <table align='center' border='0' cellpadding='0' cellspacing='0' width='600'><br><br>
              <tbody>
                ...
                <tbody>
                  ...
                  <tr>
                    <td align='left' bgcolor='#ffffff' valign='top' style='padding:0 100px;font-family:Arial, Helvetica, sans-serif;font-size:12px;' width='600'><p style='font-size:20px;font-weight:bold;'>Orden N&uacute;mero $tim</p> <p style='font-size:12px;'>Su orden de Lentes Europa Scleral se ha creado.</p><p>Si desea m&aacute;s detalles de su pedido por favor no dude en llamar al Laboratorio &Oacute;ptico Topex para nosotros un placer servirle.</p><p>Nuestro horario de atenci&oacute;n es de Lunes a viernes de 8:00 a.m a 7:00 p.m y s&aacute;bados de 7:00 a.m a 2:00 p.m</p>
...
$mailo->Password = "L3nt3s1820*"; 
      ...
      //El cuerpo del mensaje lo ponemos en formato html, haciendo 
      //que se vea en negrita
      $mailo->Subject = "Nuevo pedido orden #($tim) Lentes Europa Scleral";
      $mailo->Body = "<p>Nuevo pedido de lentes europa scleral orden n&uacute;mero <b>$tim</b></p> <p>Correo del cliente: <b>$correo</b></p> <p>Cedula F&iacute;sica o Juridica: <b>$cedula</b></p>";

      //Definimos AltBody por si el destinatario del correo no admite 
      //email con formato html
      $mailo->AltBody ="Nuevo pedido de lentes europa scleral orden n&uacute;mero $tim, Correo del cliente: $correo, Cedula F&iacute;sica o Juridica: $cedula";
